  ...
  return (
    <Routes>
      ...
      <Route path="/" element={
        ...
        <Route path="problems"    element={<ProtectedRoute route="problems">   <Problems/>  </ProtectedRoute>}/>
        <Route path="machines"    element={<ProtectedRoute route="machines">   <Machines/>  </ProtectedRoute>}/>
        <Route path="repairs"     element={<ProtectedRoute route="repairs">    <Repairs/>   </ProtectedRoute>}/>
